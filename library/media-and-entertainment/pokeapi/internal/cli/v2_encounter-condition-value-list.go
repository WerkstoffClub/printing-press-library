...
func newV2EncounterConditionValueListCmd(flags *rootFlags) *cobra.Command {
	var flagLimit int
	var flagOffset int
	var flagQ string
	var flagAll bool
	...
	cmd := &cobra.Command{
		Use:   "encounter-condition-value-list",
		Short: "List encounter condition values",
		Example: "  pokeapi-pp-cli v2 encounter-condition-value-list",
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			data, prov, err := resolvePaginatedRead(c, flags, "v2", path, map[string]string{
