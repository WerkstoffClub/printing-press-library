...
but do not stop the import.`,
  ...
  songkick-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  songkick-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | songkick-pp-cli import <resource> --input -`,
